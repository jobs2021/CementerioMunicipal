            ...
            <div class="row padding-bottom-15">
                ...
                if ($variable!=-1) {
                    foreach ($variable as $value) {
                        @$numeroParcelas=$consulta->Query("select count(*) as Nichos,(select count(*) from Parcelas t4 where t4.idCementerio='{$value['idCementerio']}' and t4.Estado='1') as Parcelas from Nichos t1 inner join Parcelas t2 on t1.idParcela=t2.idParcela inner join Cementerios t3 on t3.idCementerio=t2.idCementerio where t3.idCementerio='{$value['idCementerio']}' and t1.Estado='1' and t2.Estado='1' and t3.Estado='1'")[0];
