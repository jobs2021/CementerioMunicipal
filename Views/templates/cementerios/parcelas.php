    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="carruselEditarNicho" class="carousel slide" data-pause="true">
                    <!-- The slideshow -->
                        ...
                        <div class="carousel-item active">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <button type="button" class="btn btn-primary btn-block" data-target="#carruselEditarNicho" data-slide-to="1">Continuar</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-footer">
                                    <div class="row margin-top-15">
                                        <div class="col-6">
                                            ...
                                            <button type="button" class="btn btn-primary btn-block" data-target="#carruselEditarNicho" data-slide-to="0">Volver</button>
                                        </div>
                                        <div class="col-6">
                    ...
                    <div class="carousel-inner w-100 h-100">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="<?php echo $server;?>/parcelaActions" method="POST">
                                        ...
                                        <input type="hidden" name="Came" value="<?php echo explode('/',$_GET['action'])[0]; ?>">
                                        <input type="hidden" name="idCementerio" value="<?php echo $idCementerio; ?>">
                                        <input type="hidden" name="nichos" id="nichosSend_">
                                        <div class="form-group">
                                            <label for="nombre">Número:</label>
                                            <input type="text" class="form-control" id="numero_" name="numero">
                                        </div>
                                        <div class="form-group">
                                            <label for="edad">Poligono:</label>
                                            <input type="text" class="form-control" id="poligono_" name="poligono">
                                        </div>
                                        <div class="form-group">
                                            <label for="sel2" :>Tipo:</label>
                                            <select class="form-control" id="tipo_" name="tipo">
                                                <?php
                                                foreach ($tipoParcela as $value) {
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col">
                                            <div>
                                                <svg version="1.1" id="nicho_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="300px" viewBox="0 0 300 300" enable-background="new 0 0 300 300" xml:space="preserve">
                                                    <g class="nicho3_">
                                                        <rect class="btn-hover3_" x="100.666" y="124.698" fill="rgba(0,0,0,0)" stroke="#007bff" stroke-width="1" stroke-miterlimit="10" width="99.776" height="32" />
                                                        <text class="text-hover3_" transform="matrix(1 0 0 1 143.5537 145.0308)" fill="#007bff" font-family="'Arial'" font-size="15">3</text>
                                                    </g>
                                                    <g class="nicho2_">
                                                        <rect class="btn-hover2_" x="100.666" y="163.838" fill="rgba(0,0,0,0)" stroke="#007bff" stroke-width="1" stroke-miterlimit="10" width="99.776" height="32" />
                                                        <text class="text-hover2_" transform="matrix(1 0 0 1 143.5537 183.0313)" fill="#007bff" font-family="'Arial'" font-size="15">2</text>
                                                    </g>
                                                    <g class="nicho1_">
                                                        <rect class="btn-hover1_" x="100.666" y="202.15" fill="rgba(0,0,0,0)" stroke="#007bff" stroke-width="1" stroke-miterlimit="10" width="99.776" height="32" />
                                                        <text class="text-hover1_" transform="matrix(1 0 0 1 143.5537 221.6973)" fill="#007bff" font-family="'Arial'" font-size="15">1</text>
                                                    </g>
                                                    <g class="nicho0_">
                                                        <rect class="btn-hover0_" x="100.666" y="259.414" fill="rgba(0,0,0,0)" stroke="#007bff" stroke-width="1" stroke-miterlimit="10" width="99.776" height="32" />
                                                        <text class="text-hover0_" transform="matrix(1 0 0 1 144.8867 280.0605)" fill="#007bff" font-family="'Arial'" font-size="15">0</text>
                                                    </g>
                                                    <path fill="#B1B1B1" d="M235.761,240.162V110.478c0.177-0.626,0.31-1.27,0.383-1.933h8.85c8.512,0,15.412-5.373,15.412-12v-6.435
                        c0-6.628-6.9-12-15.412-12h-21.735v-3.144c0-6.208-4.701-11.241-10.501-11.241h-11.769c-1.27-9.64-22.542-17.378-49.104-17.884
                        V20.328h11.712c0.961,0,1.738-1.217,1.738-2.718s-0.777-2.718-1.738-2.718h-11.712V2.717c0-1.5-1.217-2.717-2.717-2.717
                        ...
                        85.543,300.361 85.543,300 195.326,300 195.326,300.361 300,300.361 300,253.758 " />
                                ...
                                <div class="card-footer">
                                    <div class="row margin-top-15">
                                        <div class="col-6">
                                            <input id="checkbox0_" type="checkbox" name="nicho0" value="0" hidden="true">
                                            <input id="checkbox1_" type="checkbox" name="nicho1" value="1" hidden="true">
                                            <input id="checkbox2_" type="checkbox" name="nicho2" value="2" hidden="true">
                                            <input id="checkbox3_" type="checkbox" name="nicho3" value="3" hidden="true">
                                            <button type="button" class="btn btn-primary btn-block" data-target="#carruselAgregarNicho" data-slide-to="0">Volver</button>
                                        </div>
                                        <div class="col-6">
                                            <button id="btnSave_" type="submit" class="btn btn-primary btn-block">Guardar</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btnSave').click(function(event) {
                    ...
                    if (resultado==-1 || $.isEmptyObject(resultado)) {
                       nichosD = nichosR;
                       //alert('entro en vacio');
                    }else if(nichosR==-1 || $.isEmptyObject(nichosR)){
                        nichosA=resultado;
...
<script type="text/javascript">
    ...
    class nichoBtn_ {
            constructor(n) {
                this.activo = false;
                this.clase = '.nicho' + n+'_';
                this.posicion = n;
            }

            nichoHover(n) {
                $(".btn-hover" + n+'_').css("fill", "#007bff");
                $(".text-hover" + n+'_').css("fill", "#fff");
            }

            nichoLeave(n) {
                if (this.activo == false) {
                    $(".btn-hover" + n+'_').css("fill", "#fff");
                    $(".text-hover" + n+'_').css("fill", "#007bff");
                }
            }
            ...
            toggleActivador() {
                if (this.activo == false) {
                    this.activo = true;
                    this.nichoHover(this.posicion);
                    document.getElementById("checkbox" + this.posicion+'_').checked = true;
                } else {
                    this.activo = false;
                    this.nichoLeave(this.posicion);
                    document.getElementById("checkbox" + this.posicion+'_').checked = false;
                }
            }
        }

        function crearEvent_(obj) {
            $(obj.clase).mouseover(function() { obj.nichoHover(obj.posicion); });
            $(obj.clase).mouseleave(function() { obj.nichoLeave(obj.posicion); });
            $(obj.clase).click(function() { obj.toggleActivador(); });
        }
        var nicho0_ = new nichoBtn_('0');
        var nicho1_ = new nichoBtn_('1');
        var nicho2_ = new nichoBtn_('2');
        var nicho3_ = new nichoBtn_('3');
    ...
    $('#btnSave_').click(function() {
            ...
            for (var i = 0; i <= 3; i++) {
                if (document.getElementById("checkbox" + i+'_').checked == true) {
                    resultado_.push(document.getElementById("checkbox" + i+'_').value);

                }
            }
            $('#nichosSend_').attr('value',resultado_);
            //alert(resultado);
        });
