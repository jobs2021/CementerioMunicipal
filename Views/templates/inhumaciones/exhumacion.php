<?php 
    ...
    $query = "SELECT idExhumacion, (select concat(t2.NombresFallecido,' ',t2.ApellidosFallecido) from Enterramientos t2 where t1.idEnterramiento=t2.idEnterramiento) as 'Fallecido',ViaJudicial,Fecha,Observaciones from Exhumaciones t1 where t1.Estado='1';";
    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item">
            <div class="row justify-content-center">
                ...
                <button type="button" class="btn btn-outline-dark float-right" data-toggle="modal" data-target="#myModal">Nueva Exhumacion</button>
            </div>
        </li>
    </ul>
                        ...
                        if($DataResult!=-1){
                            ...
                            <td class=\"text-right\">
                                <div class=\"row-btn\">
                                    ...
                                    <a idTraslado=\"{$key['idExhumacion']}\" numero=\"{$i}\" href=\"#\" data-toggle=\"modal\" data-target=\"#modalEliminar\" class=\"text-danger btn-eliminar-traslado \"><i class=\"fas fa-trash icon\" title=\"Eliminar\"></i></a>
                                </div>
                            </td>
                        </tr>";
                        $i++;
...
<div class="modal fade" id="myModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Nueva Exhumacion</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <div class="row justify-content-center">
                        ...
                        <form action="<?php echo $server;?>/inhumacionesActions" method="POST">
                            ...
                            <div class="form-row">
                                <div class="form-group col-6">
                                   <label for="legalidad" :>Via Judicial:</label>
                                    <select name="ViaJudicial" class="form-control" id="legalidad">
