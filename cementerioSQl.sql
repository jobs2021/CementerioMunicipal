...
CREATE TABLE IF NOT EXISTS `cementerio`.`Cementerios` (
  `idCementerio` INT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `cementerio`.`Ctl_Estados_Nichos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cementerio`.`Ctl_Estados_Nichos` (
...
CREATE TABLE IF NOT EXISTS `cementerio`.`Nichos` (
  ...
  `NumeroOrden` VARCHAR(45) NOT NULL DEFAULT 0,
  `Fecha` DATE NOT NULL,
  `Estado` INT(1) NULL,
  ...
  CONSTRAINT `fk_Nichos_Ctl_Estados_Nichos1`
    ...
    REFERENCES `cementerio`.`Ctl_Estados_Nichos` (`idCtlEstadosNicho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cementerio`.`Pagos_Arrendamientos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cementerio`.`Pagos_Arrendamientos` (
  `idPago_Arrendamiento` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idPago_Arrendamiento`, `Parcelas_idParcela`),
  INDEX `fk_Pagos_Arrendamientos_Parcelas1_idx` (`Parcelas_idParcela` ASC),
  CONSTRAINT `fk_Pagos_Arrendamientos_Parcelas1`
    FOREIGN KEY (`Parcelas_idParcela`)
    REFERENCES `cementerio`.`Parcelas` (`idParcela`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cementerio`.`Usuarios` (
  `isUsuario` VARCHAR(45) NOT NULL,
  `NombreUsuario` (16) NOT NULL,
  `CorreoUsuario` (255) NULL,
